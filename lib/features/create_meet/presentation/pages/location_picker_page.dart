...
import 'package:social_network_platform/features/create_meet/presentation/bloc/location_picker_event.dart';
import 'package:social_network_platform/features/create_meet/presentation/bloc/location_picker_state.dart';
          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                ...
                //   right: 20,
                //   left: 20,
                //   child: DefaultButtonWidget(text: 'Select', onPressed: () {}),
                // ),
                Center(
                  child: Text(
